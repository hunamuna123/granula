      ...
      <div class="mx-auto">
        ...
        <div class="bg-gradient-to-r from-[#2563EB] to-[#1D4ED8] rounded-xl sm:rounded-2xl p-4 sm:p-6 mb-4 sm:mb-6">
          <div class="flex items-center space-x-3 sm:space-x-4">
            ...
            <div class="min-w-0">
              <h1 class="text-xl sm:text-2xl md:text-3xl font-bold text-white truncate">{{ user.full_name || 'Пользователь' }}</h1>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-6 mb-4 sm:mb-6">
            ...
            <div class="space-y-3 sm:space-y-4">
              ...
              <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between p-2.5 sm:p-3 bg-[#26272A] rounded-lg gap-1 sm:gap-4">
                <div class="flex items-center">
                  ...
                  <span class="text-gray-300 text-sm">Полное имя</span>
                </div>
                <span class="text-white text-sm font-medium">{{ user.full_name || 'Не указано' }}</span>
              </div>
              ...
              <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between p-2.5 sm:p-3 bg-[#26272A] rounded-lg gap-1 sm:gap-4">
                <div class="flex items-center">
                  ...
                  <span class="text-gray-300 text-sm">Статус</span>
                </div>
                <span class="text-white text-sm font-medium" :class="user.is_active ? 'text-green-400' : 'text-red-400'">
          ...
          <div class="bg-[#18181B] border border-[#26272A] rounded-xl p-4 sm:p-6">
            <div class="flex items-center mb-3 sm:mb-4">
              <div class="w-8 h-8 sm:w-10 sm:h-10 bg-[#2563EB]/20 rounded-lg flex items-center justify-center mr-2 sm:mr-3">
                <svg class="w-4 h-4 sm:w-5 sm:h-5 text-[#2563EB]" fill="currentColor" viewBox="0 0 24 24">
                  <path
                    d="M11.944 0A12 12 0 0 0 0 12a12 12 0 0 0 12 12 12 12 0 0 0 12-12A12 12 0 0 0 12 0a12 12 0 0 0-.056 0zm4.962 7.224c.1-.002.321.023.465.14a.506.506 0 0 1 .171.325c.016.093.036.306.02.472-.18 1.898-.962 6.502-1.36 8.627-.168.9-.499 1.201-.82 1.23-.696.065-1.225-.46-1.9-.902-1.056-.693-1.653-1.124-2.678-1.8-1.185-.78-.417-1.21.258-1.91.177-.184 3.247-2.977 3.307-3.23.007-.032.014-.15-.056-.212s-.174-.041-.249-.024c-.106.024-1.793 1.14-5.061 3.345-.48.33-.913.49-1.302.48-.428-.008-1.252-.241-1.865-.44-.752-.245-1.349-.374-1.297-.789.027-.216.325-.437.893-.663 3.498-1.524 5.83-2.529 6.998-3.014 3.332-1.386 4.025-1.627 4.476-1.635z" />
                </svg>
              </div>
              <h2 class="text-lg sm:text-xl font-semibold text-white">Telegram</h2>
            </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-6">
          ...
          <div class="bg-[#18181B] border border-[#26272A] rounded-xl p-4 sm:p-6">
            <div class="flex items-center mb-3 sm:mb-4">
              <div class="w-8 h-8 sm:w-10 sm:h-10 bg-purple-500/20 rounded-lg flex items-center justify-center mr-2 sm:mr-3">
              ...
              <h2 class="text-lg sm:text-xl font-semibold text-white">Команда</h2>
            </div>
          ...
          <div class="bg-[#18181B] border border-[#26272A] rounded-xl p-4 sm:p-6">
            <div class="flex items-center mb-3 sm:mb-4">
              <div class="w-8 h-8 sm:w-10 sm:h-10 bg-orange-500/20 rounded-lg flex items-center justify-center mr-2 sm:mr-3">
                <svg class="w-4 h-4 sm:w-5 sm:h-5 text-orange-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                </svg>
              </div>
              <h2 class="text-lg sm:text-xl font-semibold text-white">Активность</h2>
            </div>
